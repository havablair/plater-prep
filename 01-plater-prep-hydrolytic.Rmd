...
incl_templates <- fluor_import %>% 
  mutate(plater_templates = map2(sheet, fluor_data, template_fun), 
         export_paths = as.character(glue("./auto_templates_hydrolytic/{sheet}.csv")))
...
See if the `plater` function `read_plates()` will work with the templates you just created 

---
title: "Pre-Process Data from Plate Reader: Oxidative Enzymes (PO & PER)"
...
incl_templates <- fluor_import %>% 
  mutate(plater_templates = map2(sheet,fluor_data, template_fun), 
         export_paths = as.character(glue("./auto_templates_oxidative/plater-{sheet}.csv")))
...
- Add ideas for additional improvements to this script here. 